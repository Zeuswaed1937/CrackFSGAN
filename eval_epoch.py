...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_sample', type=int, default=3000, help = "The number of generated images")
    ...
    parser.add_argument('--epochs', type=str, default='15000', help='')
    ...
    ckpt = f"/your/model/path/models/{epoch}.pth" 
    ...
    dist = '/your/saving/path/eval_%s'%(epoch)
